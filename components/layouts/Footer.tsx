      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="text-center">
            <h4 className="text-xl font-semibold mb-4 text-pink-600 dark:text-pink-300">Enlaces Rápidos</h4>
          ...
          <div className="text-center md:text-right">
            <h4 className="text-xl font-semibold mb-4 text-pink-600 dark:text-pink-300">Síguenos</h4>
